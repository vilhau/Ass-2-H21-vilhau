...
For å forklare dette bedre kan vi begynne med å finne maksimumsverdien av variablen *income*.

```{r}
summary(hoyde)
```

Fra summeringstabellen ser vi at maksimumsverdien til variablen *income* er 343,830. Videre kan vi undersøke hvor mange av observasjonene
